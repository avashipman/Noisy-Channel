...
jsPsych.plugins["survey-distractor"] = (function () {
  ...
  function preventBackspace(e) {
    ...
    htmlDistractor += '<img id="distractor-stimulus" src="'+trial.stimulus[0]+'" style="';
    ...
    function slideShow() {
      ...
      document.getElementById("distractor-stimulus").classList.remove('responded')
    ...
    var after_response = function (info) {
      ...
      if (trial.choices.includes(info.key)) {
        distractor_data.push(imgArray[curIndex] === 'target.png' )
      }
    };
    */
    ...
    display_element_main_task
      ...
      .addEventListener("submit", function (e) {
        ...
        var trial_data = {
          ...
          correctKeyPressed: distractor_data,
